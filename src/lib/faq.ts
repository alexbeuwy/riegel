export const faqs: { q: string; a: string }[] = [
  ...
  },
  {
    ...
    a: "Kostenlos und in zwei Stufen: Zuerst eine datenbasierte Sofort-Einschätzung über unseren Online-Rechner, anschließend auf Wunsch eine ausführliche, persönliche Bewertung vor Ort.",
  },
  {
  ...
  },
  {
    ...
    a: "Das hängt von Lage, Zustand und Preisstrategie ab. Durch gezielte Vermarktung und vorgemerkte Kaufinteressenten erreichen wir häufig eine sehr zügige, diskrete Abwicklung.",
  },
];
