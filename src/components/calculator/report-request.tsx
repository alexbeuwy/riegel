...
export function ReportRequest({
  ...
  if (done) {
    return (
      <div className="mx-auto mt-10 max-w-2xl rounded-2xl border border-accent/30 bg-surface p-8 text-center">
        <span
        ...
        <h3 className="t-num-d mt-4 text-xl font-semibold">Ihr Report ist unterwegs</h3>
      ...
      {!open ? (
        ...
        <div className="mt-6">
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <input className={`${inputCls} sm:col-span-2`} value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Telefon (optional)" />
